...
public:
	...
	BEGIN_SINK_MAP(CTangramCoreEvents)
		SINK_ENTRY_INFO(/*nID =*/ 1, __uuidof(_ITangram), /*dispid =*/ 0x00000001, OnExtendComplete, &ExtendComplete)
...
public:
	...
	virtual void __stdcall  OnMessageReceived(BSTR bstrXml, BSTR bstrData) {};
	...
	BEGIN_SINK_MAP(CWndNodeEvents)
		...
		SINK_ENTRY_INFO(/*nID =*/ 1, __uuidof(_IWndNodeEvents), /*dispid =*/ 0x00000008, OnMessageReceived, &IPCMsg2)
	END_SINK_MAP()
};
