...
protected:
	...
	STDMETHOD(get_WndFrame)(IWndFrame** pVal);
	STDMETHOD(Active)();
	STDMETHOD(CloseTangramUI)();
	STDMETHOD(ExtendEx)(BSTR bstrKey, BSTR bstrXml, IWndNode** ppNode);
	STDMETHOD(ExtendInView)(int nIndex, BSTR bstrKey, BSTR bstrXml, IWndNode** ppRetNode);
...
public:
	...
	map<CString, CWndFrame*>	m_mapTangramFrame;

	CEclipseWnd*				m_pEclipseWnd;
	CTangramWndPageProxy*		m_pTangramWndPageProxy;
...
public:
	...
	STDMETHOD(get_TopPage)(IWndPage** pVal);
	STDMETHOD(get_TopFrame)(IWndFrame** pVal);
	...
	STDMETHOD(AttachCLRObjEvent)(IDispatch* Sender, WindowEventType nEventType, VARIANT_BOOL bAttachEvent);
	STDMETHOD(Extend)(BSTR bstrFrameName, BSTR bstrKey, BSTR bstrXml, IWndNode** ppNode);
	STDMETHOD(ExtendEx)(BSTR bstrFrameName, BSTR bstrKey, BSTR bstrXml, IWndNode** ppNode);
