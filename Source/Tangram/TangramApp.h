...
#pragma once
#include <jni.h>
#include "chromium\ChromeBrowserProxy.h"
...
class CTangramFrameHelperWnd :
	public CWindowImpl<CTangramFrameHelperWnd, CWindow>
{
public:
	CTangramFrameHelperWnd(void)
	{
		m_strID = _T(""); 
	};
	...
	CString m_strID;
	DECLARE_WND_CLASS(_T("Tangram FrameHelperWnd Window Class"))
	BEGIN_MSG_MAP(CTangramFrameHelperWnd)
	END_MSG_MAP()
	void OnFinalMessage(HWND hWnd);
};
