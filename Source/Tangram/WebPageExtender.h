...
{
public:
	CJSProxyObj(CWebPageExtender* _pJSExtender, IDispatch *pDisp, const GUID iid, CString strPrefix);
	~CJSProxyObj();
...
private:
	...
	CWebPageExtender*			m_pWebPageExtender;
	CSimpleMap<DISPID, BSTR>	m_mapDispId;
	map<DISPID, CString>		m_mapDispID;
